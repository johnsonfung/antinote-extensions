...
(function () {
    ...
    const ai = new Command({
        ...
        tutorials: [
            ...
            new TutorialCommand({ command: "ai(Explain quantum computing in simple terms, 300)", description: "Ask for a longer explanation — about 300 tokens' worth" }),
    ...
    ai.execute = function (payload) {
        try {
            const [prompt, length, temperature] = this.getParsedParams(payload);
